  ...
  const initialSampleData = [
    {
      ...
      income: '₹60,000 – ₹1,00,000 / month',
      religion: 'Hindu',
      community: 'BC',
      caste: 'Pillai / Vellalar (பிள்ளை / வெள்ளாளர்)',
      subCaste: 'Saiva Pillai',
      casteReligion: 'Hindu / Pillai / Vellalar (Saiva Pillai)',
    ...
    },
    {
      ...
      religion: 'Hindu',
      community: 'BC',
      caste: 'Mudaliar (முதலியார்)',
      subCaste: 'Thondaimandala Mudaliar',
      casteReligion: 'Hindu / Mudaliar (Thondaimandala Mudaliar)',
